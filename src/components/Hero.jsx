...
//     >
//       {/* Background Glow */}
//       <div className="absolute -top-40 -left-40 w-96 h-96 bg-red-600/20 blur-[180px] rounded-full" />
//       <div className="absolute bottom-0 right-0 w-96 h-96 bg-red-500/10 blur-[200px] rounded-full" />
...
//             <p className="text-red-500 uppercase tracking-[4px] font-semibold mb-5">
...
//               business solutions, and creative digital experiences that
...
//               <a
//                 href="#portfolio"
//                 className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-red-600 hover:bg-red-700 transition duration-300 shadow-[0_0_30px_rgba(255,0,60,.4)] font-semibold"
//               >
//                 View Portfolio
//               </a>
...
//               <a
//                 href="#contact"
//                 className="inline-flex items-center justify-center px-8 py-4 rounded-full border border-red-500 text-white hover:bg-red-600 transition duration-300 font-semibold"
//               >
//                 Contact Us
//               </a>
//             </div>
...
//             <div className="absolute w-96 h-96 bg-red-500/20 rounded-full blur-[120px]" />

//             <img
//               src={heroImage}
//               alt="Hero"
//               className="relative w-full max-w-lg drop-shadow-[0_0_40px_rgba(255,0,60,.35)]"
//             />
